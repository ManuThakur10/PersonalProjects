...
if __name__ == "__main__":
    ...
    joblib.dump(model,model_path) #THIS IS WHAT CAUSED ME TO MAKE 3 SEPARATE FILES! 
        # It's a hassle to access filepaths otherwise and deploy them separately
    print("Combined Model persisted at " + model_path)
    print()
